...
public class Buffer extends Node {
   ...
   public Buffer(int var1, boolean var2) {
      this.array = class235.ByteArrayPool_getArrayBool(var1, var2);
   }

   public Buffer(int var1) {
      this.array = class195.ByteArrayPool_getArray(var1);
      this.offset = 0;
   }
   ...
   public void writeStringCp1252NullTerminated(String var1) {
      ...
      if (var2 >= 0) {
         ...
         this.offset += class134.encodeStringCp1252(var1, 0, var1.length(), this.array, this.offset);
   ...
   @Export("writeLengthShortAt")
   public void writeLengthShortAt(int var1) {
   ...
   @Export("writeByteLength")
   public void writeByteLength(int var1) {
      if (var1 >= 0 && var1 <= 255) {
         this.array[this.offset - var1 - 1] = (byte)var1;
      } else {
         throw new IllegalArgumentException();
   ...
   public String readStringCp1252NullTerminated() {
      ...
      return var2 == 0 ? "" : Tiles.decodeStringCp1252(this.array, var1, var2);
   }
   ...
   public String readStringCp1252NullCircumfixed() {
      ...
      if (var1 != 0) {
         ...
         return var3 == 0 ? "" : Tiles.decodeStringCp1252(this.array, var2, var3);
      }
   }
   ...
   public String readCESU8() {
      ...
      if (var1 != 0) {
         ...
         if (var2 + this.offset > this.array.length) {
            ...
            String var3 = class343.method6312(this.array, this.offset, var2);
            this.offset += var2;
            return var3;
         }
      }
   ...
   public int writeCrc(int var1) {
      int var2 = class132.crc32(this.array, var1, this.offset);
      this.writeInt(var2);
      return var2;
   }
   ...
   public boolean checkCrc() {
      this.offset -= 4;
      int var1 = class132.crc32(this.array, 0, this.offset);
   ...
   public void writeP128Byte(int var1) {
   ...
   @Export("writeNotByte")
   public void writeNotByte(int var1) {
   ...
   @Export("writeInt24BME")
   public void writeOffByte(int var1) {
   ...
   @Export("writeWeirdShort")
   public void writeWeirdShort(int var1) {
      this.array[++this.offset - 1] = (byte)(var1 >> 8);
      this.array[++this.offset - 1] = (byte)(var1 + 128);
   }
   ...
   @Export("writeIntMLE")
   public void writeWeirdShortLE(int var1) {
      this.array[++this.offset - 1] = (byte)(var1 + 128);
      this.array[++this.offset - 1] = (byte)(var1 >> 8);
   }
   ...
   @Export("readWeirdUShortLE")
   public int readWeirdUShort() {
      this.offset += 2;
   ...
   @Export("readWeirdShort")
   public int readWeirdShort() {
      this.offset += 2;
   ...
   @Export("readWeirdShortLE")
   public int readWeirdShortLE() {
      this.offset += 2;
   ...
   public void writeIntLME(int var1) {
      this.array[++this.offset - 1] = (byte)(var1 >> 8);
      this.array[++this.offset - 1] = (byte)var1;
      this.array[++this.offset - 1] = (byte)(var1 >> 24);
      this.array[++this.offset - 1] = (byte)(var1 >> 16);
   ...
   public void writeIntBME(int var1) {
      this.array[++this.offset - 1] = (byte)(var1 >> 16);
      this.array[++this.offset - 1] = (byte)(var1 >> 24);
      this.array[++this.offset - 1] = (byte)var1;
      this.array[++this.offset - 1] = (byte)(var1 >> 8);
   ...
   @Export("readByteInverse")
   public int readInt2301() {
      this.offset += 4;
   ...
   @Export("readReverse")
   public void readReverseOffset(byte[] var1, int var2, int var3) {
